...
int main()
{
    ...
    modelPBR = std::make_unique<PBRModelRenderer>(vkDev,
                                                  (uint32_t)sizeof(UBO),
                                                  "data/DamagedHelmet/glTF/DamagedHelmet.gltf",
                                                  "data/DamagedHelmet/glTF/Default_AO.jpg",
                                                  "data/DamagedHelmet/glTF/Default_emissive.jpg",
                                                  "data/DamagedHelmet/glTF/Default_albedo.jpg",
                                                  "data/DamagedHelmet/glTF/Default_metalRoughness.jpg",
                                                  "data/DamagedHelmet/glTF/Default_normal.jpg",
