...
// this assumes all these objects were actually allocated in the initialization
// routines of the derived classes.
...
// marks the start of a rendering pass and does graphics pipeline binding and
// descriptor set binding for the current image in the swapchain
...
// a simple loop over all swapchain images that calls createUniformBuffer() for each of them
