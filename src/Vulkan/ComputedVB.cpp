...
ComputedVertexBuffer::ComputedVertexBuffer(VulkanRenderDevice &vkDev, const char *shaderName,
	...
	: ComputedItem(vkDev, uniformBufferSize), computedVertexCount(vertexCount), indexBufferSize(indexBufferSize), vertexSize(vertexSize), canDownloadVertices(supportDownload)
{
