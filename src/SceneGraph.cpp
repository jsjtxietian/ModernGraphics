...
struct MyApp : public CameraApp
{
	...
	// no need to override the destructor because all our Vulkan objects are
	// destroyed by the resource management system

	// may contain arbitrary ImGui library calls that are
	// internally converted into a list of Vulkan commands
	...
	// gets called once per fixed time interval
