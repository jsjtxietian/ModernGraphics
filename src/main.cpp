...
const std::string TEXTURE_PATH = "data/viking_room/viking_room.png";
...
struct Vertex
{
    ...
    // Vertex struct as key in a hash table requires to implement two functions: equality test and hash calculation
...
private:
    ...
    void generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
    {
        ...
        // record each of the VkCmdBlitImage commands. Note that the loop variable starts at 1, not 0.
        for (uint32_t i = 1; i < mipLevels; i++)
        {
            ...
            // source mip level is i - 1 and the destination mip level is i
            VkImageBlit blit{};
            ...
            vkCmdBlitImage(commandBuffer,
                           // we're blitting between different levels of the same image
            ...
            // waits on the current blit command to finish. All sampling operations will wait on this transition to finish
