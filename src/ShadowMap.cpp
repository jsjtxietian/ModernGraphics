...
struct MyApp : public CameraApp
{
	MyApp() : CameraApp(-95, -95),
			  ...
			  meshRenderer(ctx_, meshUniformBuffer, meshBuffer,
						   ...
						   {meshColor, meshDepth}, {"data/shaders/08/VK01_scene.vert", "data/shaders/08/VK01_scene.frag"}),

			  depthRenderer(ctx_, shadowUniformBuffer, meshBuffer, {},
							{meshShadowColor, meshShadowDepth}, {"data/shaders/08/VK01_shadow.vert", "data/shaders/08/VK01_shadow.frag"}, true),

			  planeRenderer(ctx_, meshUniformBuffer, planeBuffer,
							{fsTextureAttachment(meshShadowDepth),
							 fsTextureAttachment(ctx_.resources.loadTexture2D("data/stb_sample.jpg"))},
							{meshColor, meshDepth}, {"data/shaders/08/VK01_scene.vert", "data/shaders/08/VK01_scene.frag"}),
